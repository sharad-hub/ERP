...
namespace ERP.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
         ...
         .RegisterType<IGodownService, GodownService>()
         .RegisterType<ITariffService, TariffService>()
         .RegisterType<ISchemeService, SchemeService>()
         ...
         .RegisterType<IRepositoryAsync<Tariff>, Repository<Tariff>>()
         .RegisterType<IRepositoryAsync<UnitOfMeasurement>, Repository<UnitOfMeasurement>>()
